...
<html lang="en">
  ...
  <head>  	
    ...
    <meta name="author" content="Grayrids">
		<title>Halo Desa - Mari Bangun Desa yang Maju dan Berteknologi</title>
  ...
  <body>
    ...
    <div class="navbar navbar-invers menu-wrap">
      <div class="navbar-header text-center">
        <a class="navbar-brand logo-right" href="javascript:void(0)"><i class="mdi-image-timelapse"></i><h5>Halo Desa</h5></a>
      </div>
     ...
     <header class="hero-area" id="home">
      ...
      <div class="container">
            ...
            <div class="navbar navbar-inverse sticky-navigation navbar-fixed-top" role="navigation" data-spy="affix" data-offset-top="200">
              <div class="container">
                <div class="navbar-header">
                  <a class="logo-left " href=""><i class="mdi-image-timelapse"></i>Halo Desa</a>
                </div>
        ...
        <div class="contents text-right">
          <h1 class="wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="300ms">Halo Desa - Material UI Inspired Bootstrap Template</h1>
